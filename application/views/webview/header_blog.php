...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="background-color: #212529;">
        <a class="navbar-brand mx-2" href="<?php echo base_url() . 'pblog/index' ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav ms-auto">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link hidden active" href="<?php echo base_url() . 'pblog/index' ?>">Start</a>
                </li> -->
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url() . 'pblog/index#motto' ?>">Our Core</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url() . 'pblog/index#products' ?>">Our Products</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url() . 'pblog/index#info' ?>">Getting Started</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url() . 'pblog/index#choice' ?>">101 Questions</a>
                </li>
            </ul>
        </div>
    </nav>