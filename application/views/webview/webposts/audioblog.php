...
<section class="post js--section-post">
    <div class="container">
        ...
        <p class="longcopy">
            For a complete immersive experience while streaming or gaming. A robust and powerful sound system is a sound plan.
            <br><br>
        </p>
        <div class="row">
            <h3>Power?</h3>
            ...
            <p class="longcopy">
                How many do you need to cause havoc? 2, 3 or 5.
                <br><br>
            </p>
            <p class="longcopy">
            Patazon's got you covered with these three options: <a href="https://patazone.co.ke/shop/Home%20Theaters/MTk=" target="_blank">Home Theater Systems</a>, <a href="https://patazone.co.ke/shop/Woofers%20&%20Sub%20Woofers/MjA=" target="_blank">Woofer and Subwoofers</a> and <a href="https://patazone.co.ke/shop/Sound%20Bars/MjE=" target="_blank">Sound Bars</a>.<br><br>
            </p>
        </div>
    </div>
</section>
